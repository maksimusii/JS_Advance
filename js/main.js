...
// 2. Добавьте значения по умолчанию для аргументов функции. Как можно упростить или сократить запись функций? - В случае если в стрелочной функции выполняется только одно действие можно не писать ключевое слово 'return', фигурные скобки для действий функции и скобки для аргументов функции.
